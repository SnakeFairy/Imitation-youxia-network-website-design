...
<%
    try {
        ...
        String stringSql = "SELECT ZhName,EnName,Date,Size FROM GamesView WHERE Year='2018' AND Developer='Two Point Studios' AND Type='角色扮演RPG';";
        ...
        <div class="assort-container">
            <div class="list-type" data-type="0">
                ...
                <div class="list-ul-box">
                    <div class="list-ul">
                        <span><a href="${pageContext.request.contextPath}/2018/2018-Two Point Studios.jsp">全部</a></span>
                        <span><a  class="checked" href="${pageContext.request.contextPath}/2018/2018-Two Point Studios-RPG.jsp">角色扮演RPG</a></span>
            ...
            <div class="list-type" data-type="2">
                ...
                <div class="list-ul-box">
                    <div class="list-ul">
                        ...
                        <span><a class="checked" href="${pageContext.request.contextPath}/2018/2018-Two Point Studios-RPG.jsp" rel="nofollow" title="Two Point Studios">双点工作室</a></span>
            ...
            <div class="list-type" data-type="1">
                ...
                <div class="list-ul-box">
                    <div class="list-ul">
                        ...
                        <span><a class="checked" href="${pageContext.request.contextPath}/2018/2018-Two Point Studios-RPG.jsp">2018</a></span>
