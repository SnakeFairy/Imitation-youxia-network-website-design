...
<%
    try {
        ...
        String stringSql = "SELECT ZhName,EnName,Date,Size FROM GamesView WHERE Year='2018' AND Developer='2K Games';";
            ...
            <div class="list-type" data-type="2">
                ...
                <div class="list-ul-box">
                    <div class="list-ul">
                        ...
                        <span><a class="checked" href="${pageContext.request.contextPath}/2018/2018-2K Games.jsp" rel="nofollow" title="2K Games">2K Games</a></span>
            ...
            <div class="list-type" data-type="1">
                ...
                <div class="list-ul-box">
                    <div class="list-ul">
                        ...
                        <span><a class="checked" href="${pageContext.request.contextPath}/2018/2018-2K Games.jsp">2018</a></span>
