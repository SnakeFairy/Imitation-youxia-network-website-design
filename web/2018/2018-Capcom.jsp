...
<%
    try {
        ...
        String stringSql = "SELECT ZhName,EnName,Date,Size FROM GamesView WHERE Year='2018' AND Developer='Capcom';";
        ...
        <div class="assort-container">
            <div class="list-type" data-type="0">
                ...
                <div class="list-ul-box">
                    <div class="list-ul">
                        <span><a class="checked" href="${pageContext.request.contextPath}/2018/2018-Capcom.jsp">全部</a></span>
                        <span><a href="${pageContext.request.contextPath}/2018/2018-Capcom-RPG.jsp">角色扮演RPG</a></span>
            ...
            <div class="list-type" data-type="2">
                ...
                <div class="list-ul-box">
                    <div class="list-ul">
                        ...
                        <span><a class="checked" href="${pageContext.request.contextPath}/2018/2018-Capcom.jsp" rel="nofollow" title="Capcom">卡普空</a></span>
            ...
            <div class="list-type" data-type="1">
                ...
                <div class="list-ul-box">
                    <div class="list-ul">
                        ...
                        <span><a class="checked" href="${pageContext.request.contextPath}/2018/2018-Capcom.jsp">2018</a></span>
